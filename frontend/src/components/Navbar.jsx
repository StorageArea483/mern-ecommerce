...
const Navbar = () => {
	...
	return (
		<header className='fixed top-0 left-0 w-full bg-gray-950 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-blue-800'>
